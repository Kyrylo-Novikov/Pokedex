...
function dialogTemplate(pokeImgUrl, pokeGifUrl, id,idNumb) {
   return ` 
                <div id="lightbox-content${id}" onclick="closingProtection(event)"  class="card-big-view">
                    ...
                    <img src="assets/img/pfeil_links.png" alt="" class="change-Pokemon center"   onclick="changePokemon(-1)">
                    <img src="assets/img/pfeil_rechts.png" alt="" class="change-Pokemon center"   onclick="changePokemon(+1)">
...
function EvoChainTemplate(id,name, pokeImgUrl,currentChain,currentChainNmb,EvoNmb){
